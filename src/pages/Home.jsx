...
// Content-only homepage. It assumes your Navbar/Footer are provided by a parent layout.
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-10">
      ...
      <section className="grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link to="/signup" className="px-4 py-2 rounded-md border">Create free account</Link>
          </div>
          <p className="mt-3 text-xs text-gray-500">No credit card required • Free tier available</p>
        </div>
        ...
        <div className="rounded-2xl border bg-white shadow-sm overflow-hidden">
          <div className="grid grid-cols-2">
            ...
            <div className="p-3">
              ...
              <div className="aspect-[4/3] rounded-lg bg-gray-200 overflow-hidden">
                <img
                  alt="After"
                  src="/test_3_colorized_612x291.png"
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t bg-gray-50">
            ...
            <button
              ...
              onClick={() => navigate("/colorize")}
              className={`px-3 py-1.5 rounded-md text-sm ${hoverUpload ? "bg-black text-white" : "border"}`}
            >
              Upload your photo
            </button>
          </div>
      ...
      <section className="py-12">
          ...
          {[
            ...
            <li key={s.step} className="rounded-xl border bg-white p-4 shadow-sm">
              <div className="flex items-center gap-2">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-black text-white text-sm">{s.step}</span>
        ...
        <div className="mt-6">
          <Link to="/colorize" className="px-4 py-2 rounded-md bg-black text-white">Start colorizing</Link>
        </div>
      </section>

      {/* Minimal gallery (optional) */}
      <section className="py-12">
        <h2 className="text-2xl font-semibold">Sample results</h2>
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            "/test_3_colorized_612x291.png",
            "/test_3_colorized_612x291.png",
            "/test_3_colorized_612x291.png",
            "/test_3_colorized_612x291.png",
            "/test_3_colorized_612x291.png",
